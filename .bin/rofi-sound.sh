...
if [ "$@" ]; then
  # The output from the selection will be the description. Save that for alerts.
  desc="$*"
  ...
  # Get the list of outputs based on the description, which is what makes
  # sense to a human and is what we want to show in the menu.
